...
//Databace conection:
const connectString =
  "mongodb+srv://admin:admin123@postitcluster.5z19z.mongodb.net/postITDb?retryWrites=true&w=majority&appName=PostITCluster";
...
app.post("/login", async (req, res) => {
  try {
    ...
    //if everthing is OK send user and massage:
